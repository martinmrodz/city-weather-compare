...
public class WeatherServiceManager{
    ...
    public static void main(String[] args){
        ...
        System.out.println("Enter name of 2nd city: ");
        ...
        city1.callWeatherWebService(sCity1);
        city2.callWeatherWebService(sCity2);
		...
		//		- Print out which city has the HIGHEST CURRENT TEMP (NOTE: you can get city name from your m_oWeather.
                if(city1.getHighTemp()  > city2.getHighTemp())
                {
                    System.out.println(city1.getCityName() + " has higher temp");
                }
                else
                {
                    System.out.println(city2.getCityName() + " has higher temp");

                }
		// 		- Print out which city has the GREATEST RANGE between low and high.
        if(city1.getHighTemp() - city1.getLowTemp()  > city2.getHighTemp() - city2.getLowTemp())
        {
            System.out.println(city1.getCityName() + " has higher range");
        }
        else
        {
            System.out.println(city2.getCityName() + " has higher range");
